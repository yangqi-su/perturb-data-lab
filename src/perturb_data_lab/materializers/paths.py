...
def resolve_corpus_paths(
    ...
    - canonical_meta_root: ``{corpus}/canonical_meta/{dataset_id}``

    Federated topology:
    - meta_root: ``{corpus}/{dataset_id}/meta``
    - matrix_root: ``{corpus}/{dataset_id}/matrix``
    - canonical_meta_root: ``{corpus}/{dataset_id}/canonical_meta``
    """
    ...
    if topology == "aggregate":
        return CorpusPaths(
            ...
            canonical_meta_root=root / "canonical_meta" / dataset_id,
        )
    if topology == "federated":
        ...
        return CorpusPaths(
            ...
            canonical_meta_root=dataset_root / "canonical_meta",
        )
    raise ValueError(
